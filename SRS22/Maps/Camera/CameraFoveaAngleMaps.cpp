#include "../../SRS22pch.h"
#include "CameraFoveaAngleMaps.h"
...
namespace SRS22 {
	CameraFoveaAngleMap000::CameraFoveaAngleMap000(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE000_MAP, "CameraFoveaAngleMap000", true,
	...
	CameraFoveaAngleMap225::CameraFoveaAngleMap225(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE225_MAP, "CameraFoveaAngleMap225", true,
			3, CameraFoveaMap_Height, CameraFoveaMap_Width, 0.0f,
	...
	CameraFoveaAngleMap450::CameraFoveaAngleMap450(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE450_MAP, "CameraFoveaAngleMap450", true,
			3, CameraFoveaMap_Height, CameraFoveaMap_Width, 0.0f,
	...
	CameraFoveaAngleMap675::CameraFoveaAngleMap675(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE675_MAP, "CameraFoveaAngleMap675", true,
			3, CameraFoveaMap_Height, CameraFoveaMap_Width, 0.0f,
	...
	CameraFoveaAngleMap900::CameraFoveaAngleMap900(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE900_MAP, "CameraFoveaAngleMap900", true,
			3, CameraFoveaMap_Height, CameraFoveaMap_Width, 0.0f,
	...
	CameraFoveaAngleMap1125::CameraFoveaAngleMap1125(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE1125_MAP, "CameraFoveaAngleMap1125", true,
			3, CameraFoveaMap_Height, CameraFoveaMap_Width, 0.0f,
	...
	CameraFoveaAngleMap1350::CameraFoveaAngleMap1350(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE1350_MAP, "CameraFoveaAngleMap1350", true,
			3, CameraFoveaMap_Height, CameraFoveaMap_Width, 0.0f,
	...
	CameraFoveaAngleMap1575::CameraFoveaAngleMap1575(Brain* br) :
		ConceptArray(br, MapUidE::CAMERAFOVEAANGLE1575_MAP, "CameraFoveaAngleMap1575", true,
			3, CameraFoveaMap_Height, CameraFoveaMap_Width, 0.0f,
